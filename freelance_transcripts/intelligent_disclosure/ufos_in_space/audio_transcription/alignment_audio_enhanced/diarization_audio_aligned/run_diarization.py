...
with open("/home/johnny5/Sherlock/freelance_transcripts/intelligent_disclosure/ufos_in_space/audio_transcription/alignment_audio_enhanced/audio_aligned.json", "r") as f:
    data = json.load(f)
...
diarization = diarization_pipeline("/home/johnny5/Sherlock/freelance_transcripts/intelligent_disclosure/ufos_in_space/audio_diarize.wav", num_speakers=2)
...
# Save output
output_file = Path("/home/johnny5/Sherlock/freelance_transcripts/intelligent_disclosure/ufos_in_space/audio_transcription/alignment_audio_enhanced/diarization_audio_aligned") / "audio_diarized.json"
