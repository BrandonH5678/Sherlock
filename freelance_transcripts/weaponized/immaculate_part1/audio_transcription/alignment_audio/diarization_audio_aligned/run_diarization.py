...
with open("/home/johnny5/Sherlock/freelance_transcripts/weaponized/immaculate_part1/audio_transcription/alignment_audio/audio_aligned.json", "r") as f:
    data = json.load(f)
...
diarization = diarization_pipeline("/home/johnny5/Sherlock/freelance_transcripts/weaponized/immaculate_part1/audio_diarize.wav", num_speakers=3)
...
# Save output
output_file = Path("/home/johnny5/Sherlock/freelance_transcripts/weaponized/immaculate_part1/audio_transcription/alignment_audio/diarization_audio_aligned") / "audio_diarized.json"
