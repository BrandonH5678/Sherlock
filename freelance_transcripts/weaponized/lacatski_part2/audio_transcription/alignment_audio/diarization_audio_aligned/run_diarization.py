...
with open("/home/johnny5/Sherlock/freelance_transcripts/weaponized/lacatski_part2/audio_transcription/alignment_audio/audio_aligned.json", "r") as f:
    data = json.load(f)
...
# Run diarization
diarization = diarization_pipeline("/home/johnny5/Sherlock/freelance_transcripts/weaponized/lacatski_part2/audio_diarize.wav")
...
# Save output
output_file = Path("/home/johnny5/Sherlock/freelance_transcripts/weaponized/lacatski_part2/audio_transcription/alignment_audio/diarization_audio_aligned") / "audio_diarized.json"
