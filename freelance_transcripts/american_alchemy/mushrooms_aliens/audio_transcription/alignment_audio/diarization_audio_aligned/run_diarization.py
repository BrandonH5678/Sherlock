...
with open("/home/johnny5/Sherlock/freelance_transcripts/american_alchemy/mushrooms_aliens/audio_transcription/alignment_audio/audio_aligned.json", "r") as f:
    data = json.load(f)
...
diarization = diarization_pipeline("/home/johnny5/Sherlock/freelance_transcripts/american_alchemy/mushrooms_aliens/audio_diarize.wav")

print(f"Speaker hints: auto-detect")
...
# Save output
output_file = Path("/home/johnny5/Sherlock/freelance_transcripts/american_alchemy/mushrooms_aliens/audio_transcription/alignment_audio/diarization_audio_aligned") / "audio_diarized.json"
