...
with open("/home/johnny5/Sherlock/freelance_transcripts/american_alchemy/mushrooms_aliens/audio_transcription/alignment_audio_flagged/audio_aligned.json", "r") as f:
    data = json.load(f)
...
# Save output
output_file = Path("/home/johnny5/Sherlock/freelance_transcripts/american_alchemy/mushrooms_aliens/audio_transcription/alignment_audio_flagged/diarization_audio_aligned") / "audio_diarized.json"
